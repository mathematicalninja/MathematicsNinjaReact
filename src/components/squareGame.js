...
class squareGame extends React.Component {
    // High Varience
    ...
    // change styling is a global default layout, but may need editing to shift away from "-current" and "-winning" stylings depending on how the game looks
