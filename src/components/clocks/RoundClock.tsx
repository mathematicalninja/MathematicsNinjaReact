...
function TimeArc(props: {
  ...
  if (props.snapToPrev && props.largeTime) {
    outerShift =
      (360 * props.snapToPrev * props.largeTime[0]) / props.largeTime[1]; // rotates the clock to star the time's zero at the larger time's current value
  } else {
  }
  return (
    <ArcChunk
      ...
      externalAngle={
        (360 / props.time[1]) * (props.time[0] + timeShift) + outerShift
      }
      arcGap={props.arcGap}
    ...
    return (
      ...
      >
        ...
        <TimeArc
          ...
          fill={
            this.props.fillSeconds ? this.props.fillSeconds : "var(--Grey-5)"
          }
          offset={offset}
        ...
        <TimeArc
          ...
          fill={
            this.props.fillMinutes ? this.props.fillMinutes : "var(--Grey-5)"
          }
          offset={offset}
          smooth={this.props.smooth ? this.props.smooth : 0}
          snapToPrev={snapToPrev}
